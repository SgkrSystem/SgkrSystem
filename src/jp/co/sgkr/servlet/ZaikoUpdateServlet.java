 ...
 */
@WebServlet("/ZaikoUpdateServlet")
public class ZaikoUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ZaikoUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Product product = new Product(Integer.parseInt(
				...
				Integer.parseInt(request.getParameter("Sell_q")), 
				Integer.parseInt(request.getParameter("Buy_q"))
